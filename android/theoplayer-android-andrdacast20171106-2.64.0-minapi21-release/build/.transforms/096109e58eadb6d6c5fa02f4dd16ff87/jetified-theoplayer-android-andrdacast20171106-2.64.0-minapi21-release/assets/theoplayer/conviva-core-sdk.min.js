...
!function(a,b){"function"==typeof define&&define.amd?define(b):"object"==typeof exports&&(module.exports=b()),void 0===a.Conviva&&(a.ConvivaLoading||(a.ConvivaLoading=!0,a.Conviva=b(),delete a.ConvivaLoading));
}(this,function(){var a={};return function(){"use strict";var b={};!function(){var c=a.Client=function(b,g){function i(a,b){if(!(a instanceof d))throw new Error("clientSettings parameter should be an instance of ClientSettings.");
...
var c=j._sessionFactory.getVideoSession(a);null!=c&&((null==b.applicationName||null==b.viewerId)&&(null==b.viewerId&&null!=c._contentMetadata.viewerId&&(b.viewerId=c._contentMetadata.viewerId),null==b.applicationName&&null!=c._contentMetadata.applicationName&&(b.applicationName=c._contentMetadata.applicationName)),
b.custom["c3.csid"]=C.ToString(c._id)),d=j._sessionFactory.makeVideoSession(b,u.SESSION_TYPE.AD)}),d):(j._logger.error("createAdSession(): expecting an instance of ContentMetadata for adMetadata parameter"),
d)},this.reportError=function(b,c,d){return this._released?void 0:C.isValidString(c)?d!==a.Client.ErrorSeverity.FATAL&&d!==a.Client.ErrorSeverity.WARNING?void this._logger.error("reportError(): invalid error severity: "+d):void this._exceptionCatcher.runProtected("Client.reportError",function(){
...
this.getSettings=function(){return this._settings},this.getId=function(){return this._id}};c.version="2.146.0.36444",c.NO_SESSION_KEY=-2,c.AdPosition={BUMPER:"BUMPER",PREROLL:"PREROLL",MIDROLL:"MIDROLL",
...
SETTOP:"Settop",MOBILE:"Mobile",TABLET:"Tablet",SMARTTV:"SmartTV",UNKNOWN:"Unknown"},c.AdTechnology={CLIENT_SIDE:"Client Side",SERVER_SIDE:"Server Side"},c.AdType={BLACKOUT_SLATE:"Blackout slate",TECHNICAL_DIFFICULTIES_SLATE:"Technical Difficulties slate",
COMMERCIAL_SLATE:"Commercial Break slate",OTHER_SLATE:"Other slate",VPAID:"VPAID",REGULAR:"Regular Ad"},c.AdServingType={INLINE:"Inline",WRAPPER:"Wrapper"};var d=a.ClientSettings=function(a){function b(a){
if(!C.isValidString(a))throw new Error("customerKey must be valid");this.customerKey=a}function c(a){if(C.isValidString(a)){var b=a.split("://");if("cws.conviva.com"!=b[1]&&("https"==b[0]||"http"==b[0]))return a;
}return"https://"+e.customerKey+"."+d.defaultProductionGatewayDNS}var e=this;this._customerKey=null,C.defGet(this,"customerKey",function(){return this._customerKey}),C.defSet(this,"customerKey",function(a){
C.isValidString(a)&&(this._customerKey=a)}),this._heartbeatInterval=d.defaultProductionHeartbeatInterval,C.defGet(this,"heartbeatInterval",function(){return this._heartbeatInterval}),C.defSet(this,"heartbeatInterval",function(a){
if("number"==typeof a){var b=C.NumberToUnsignedInt(a);b===a&&(this._heartbeatInterval=b)}}),this._gatewayUrl=null,C.defGet(this,"gatewayUrl",function(){return this._gatewayUrl}),C.defSet(this,"gatewayUrl",function(a){
C.isValidString(a)&&(this._gatewayUrl=a)}),b.apply(this,arguments),this.equals=function(a){return this.customerKey===a.customerKey&&this.gatewayUrl===a.gatewayUrl&&this.heartbeatInterval===a.heartbeatInterval;
...
},this.setClientMeasureInterface=function(b){C.validateInterface(b,new a.ClientMeasureInterface,"ClientMeasureInterface"),this._playerInterface=b},this.getPHT=function(){return this._playerInterface&&"function"==typeof this._playerInterface.getPHT?this._playerInterface.getPHT():-1;
...
},this.getRenderedFrameRate=function(){return this._playerInterface&&"function"==typeof this._playerInterface.getRenderedFrameRate?this._playerInterface.getRenderedFrameRate():h.DEFAULT_RENDERED_FRAME_RATE;
...
return e._lastError},d.apply(e,arguments),h.DEFAULT_SIGNAL_STRENGTH=1e3,h.DEFAULT_RENDERED_FRAME_RATE=-1};h.PlayerState={STOPPED:"STOPPED",PLAYING:"PLAYING",BUFFERING:"BUFFERING",PAUSED:"PAUSED",UNKNOWN:"UNKNOWN",
NOT_MONITORED:"NOT_MONITORED"},h.isValidPlayerState=function(a){return a===h.PlayerState.STOPPED||a===h.PlayerState.PLAYING||a===h.PlayerState.BUFFERING||a===h.PlayerState.PAUSED||a===h.PlayerState.UNKNOWN||a===h.PlayerState.NOT_MONITORED?!0:!1;
...
this.release=function(){}},l=a.StorageInterface=function(){this.saveData=function(a,b,c,d){},this.loadData=function(a,b,c){},this.release=function(){}},m=a.SystemInterface=function(a,b,c,d,e,f){function g(a,b,c,d,e,f){
C.validateInterface(a,new n,"TimeInterface"),C.validateInterface(b,new o,"TimerInterface"),C.validateInterface(c,new i,"HttpInterface"),C.validateInterface(d,new l,"StorageInterface"),C.validateInterface(e,new k,"MetadataInterface"),
C.validateInterface(f,new j,"LoggingInterface"),this._timeInterface=a,this._timerInterface=b,this._httpInterface=c,this._storageInterface=d,this._metadataInterface=e,this._loggingInterface=f}g.apply(this,arguments),
this.release=function(){this._timeInterface.release(),this._timeInterface=null,this._timerInterface.release(),this._timerInterface=null,this._httpInterface.release(),this._httpInterface=null,this._storageInterface.release(),
this._storageInterface=null,this._metadataInterface.release(),this._metadataInterface=null,this._loggingInterface.release(),this._loggingInterface=null}},n=a.TimeInterface=function(){this.getEpochTimeMs=function(){},
this.release=function(){}},o=a.TimerInterface=function(){this.createTimer=function(a,b,c){},this.release=function(){}},p=b.JSON2={};!function(){function a(a){return 10>a?"0"+a:a}function b(a){return d.lastIndex=0,
d.test(a)?'"'+a.replace(d,function(a){var b=g[a];return"string"==typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(a,d){var g,i,j,k,l,m=e,n=d[a];switch(n&&"object"==typeof n&&"function"==typeof n.toJSON&&(n=n.toJSON(a)),
...
l=[],Object.prototype.toString.apply(n)===Object.prototype.toString.apply([])){for(k=n.length,g=0;k>g;g+=1)l[g]=c(g,n)||"null";return j=0===l.length?"[]":e?"[\n"+e+l.join(",\n"+e)+"\n"+m+"]":"["+l.join(",")+"]",
e=m,j}if(h&&"object"==typeof h)for(k=h.length,g=0;k>g;g+=1)"string"==typeof h[g]&&(i=h[g],j=c(i,n),j&&l.push(b(i)+(e?": ":":")+j));else for(i in n)Object.prototype.hasOwnProperty.call(n,i)&&(j=c(i,n),j&&l.push(b(i)+(e?": ":":")+j));
return j=0===l.length?"{}":e?"{\n"+e+l.join(",\n"+e)+"\n"+m+"}":"{"+l.join(",")+"}",e=m,j}}"function"!=typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null;
...
r.REQUEST_PLATFORM_METADATA_KEY_MODULE_VERSION="mv",r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_NAME="pt",r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_VERSION="ptv",r.REQUEST_KEY_PROTOCOL_CAPP="caps",
r.REQUEST_EVENT_KEY_TYPE="t",r.REQUEST_EVENT_KEY_SEQUENCE_NUMBER="seq",r.REQUEST_EVENT_KEY_SESSION_TIME="st",r.REQUEST_EVENT_KEY_SEEK_ACT_TYPE="act",r.REQUEST_EVENT_KEY_SEEK_TO_POS="skto",r.REQUEST_ERROR_EVENT_KEY_MESSAGE="err",
r.REQUEST_ERROR_EVENT_KEY_FATAL="ft",r.REQUEST_STATE_CHANGE_EVENT_KEY_NEW="new",r.REQUEST_STATE_CHANGE_EVENT_KEY_OLD="old",r.REQUEST_CUSTOM_EVENT_KEY_NAME="name",r.REQUEST_CUSTOM_EVENT_KEY_ATTRIBUTES="attr",
r.REQUEST_HEARTBEAT_INFO_KEY_SEQUENCE_NUMBER="seq",r.REQUEST_HEARTBEAT_INFO_KEY_STATUS="err",r.REQUEST_HEARTBEAT_INFO_KEY_ROUNDTRIP_TIME="rtt",r.REQUEST_KEY_IS_AD_SESSION="ad",r.convertPlayerState=function(a){
switch(a){case h.PlayerState.STOPPED:return r.eStopped;case h.PlayerState.PLAYING:return r.ePlaying;case h.PlayerState.BUFFERING:return r.eBuffering;case h.PlayerState.PAUSED:return r.ePaused;case h.PlayerState.NOT_MONITORED:
return r.eNotMonitored;default:return r.eUnknown}},r.eStopped=1,r.ePlaying=3,r.eBuffering=6,r.ePaused=12,r.eNotMonitored=98,r.eUnknown=100,r.SessionFlags={GLOBAL:0,VIDEO:1,QUALITY_METRICS:2,BITRATE_METRICS:4
},r.Capabilities={INSIGHTS:0};var s=(b.JSONInterface=function(){this.encode=function(a){},this.decode=function(a){}},b.LibJSONInterface=function(){this.encode=function(a){var b=null;try{b=p.stringify(a);
}catch(c){}return b},this.decode=function(a){var b=null;try{b=q(a)}catch(c){}return C.isObject(b)||(b=null),b}}),t=b.CwsHeartbeat=function(){function a(){}this._data={},a.apply(this,arguments),this.get=function(){
return this._data},this.setField=function(a,b){this._data[a]=b},this.setInnerField=function(a,b,c){this._data[a]||(this._data[a]={}),this._data[a][b]=c},this.setMessageType=function(a){this.setField(r.REQUEST_KEY_MESSAGE_TYPE,a);
},this.setSessionTime=function(a){this.setField(r.REQUEST_KEY_SESSION_TIME,a)},this.setSessionStartTime=function(a){this.setField(r.REQUEST_KEY_SESSION_START_TIME,a)},this.setIsLive=function(a){this.setField(r.REQUEST_KEY_IS_LIVE,a);
},this.setSequenceNumber=function(a){this.setField(r.REQUEST_KEY_SEQUENCE_NUMBER,a)},this.setCustomerKey=function(a){this.setField(r.REQUEST_KEY_CUSTOMER_KEY,a)},this.setClientId=function(a){this.setField(r.REQUEST_KEY_CLIENT_ID,a);
},this.setClientVersion=function(a){this.setField(r.REQUEST_KEY_CLIENT_VERSION,a)},this.setProtocolVersion=function(a){this.setField(r.REQUEST_KEY_PROTOCOL_VERSION,a)},this.setCapfield=function(a){this.setField(r.REQUEST_KEY_PROTOCOL_CAPP,a);
},this.setSessionId=function(a){this.setField(r.REQUEST_KEY_SESSION_ID,a)},this.setInstanceId=function(a){this.setField(r.REQUEST_KEY_INSTANCE_ID,a)},this.setViewerId=function(a){this.setField(r.REQUEST_KEY_VIEWER_ID,a);
},this.setAssetName=function(a){this.setField(r.REQUEST_KEY_ASSET_NAME,a)},this.setPlayerName=function(a){this.setField(r.REQUEST_KEY_PLAYER_NAME,a)},this.setTags=function(a){this.setField(r.REQUEST_KEY_TAGS,a);
},this.setSessionFlags=function(a){this.setField(r.REQUEST_KEY_SESSION_FLAGS,a)},this.setCapabilities=function(a){this.setField(r.REQUEST_KEY_CAPABILITIES,a)},this.setEvents=function(a){this.setField(r.REQUEST_KEY_EVENTS,a);
},this.setIsSdkClient=function(a){this.setField(r.REQUEST_KEY_IS_SDK_CLIENT,a)},this.setLogs=function(a){this.setField(r.REQUEST_KEY_LOGS,a)},this.setHeartbeatInfos=function(a){this.setField(r.REQUEST_KEY_HEARTBEAT_INFOS,a);
},this.setPlayerState=function(a){this.setField(r.REQUEST_KEY_PLAYER_STATE,a)},this.setPauseJoin=function(a){this.setField(r.REQUEST_KEY_PAUSE_JOIN,a)},this.setContentLength=function(a){this.setField(r.REQUEST_KEY_CONTENT_LENGTH,a);
},this.setBitrate=function(a){this.setField(r.REQUEST_KEY_BITRATE,a)},this.setResource=function(a){this.setField(r.REQUEST_KEY_RESOURCE,a)},this.setEncodedFrameRate=function(a){this.setField(r.REQUEST_KEY_ENCODED_FRAME_RATE,a);
},this.setAverageFrameRate=function(a){this.setField(r.REQUEST_KEY_AVERAGE_FRAME_RATE,a)},this.setRfpsObservationCount=function(a){this.setField(r.REQUEST_KEY_RFPS_COUNT,a)},this.setRfpsTotal=function(a){
this.setField(r.REQUEST_KEY_RFPS_TOTAL,a)},this.setPlatformMetadataSchema=function(a){this.setInnerField(r.REQUEST_KEY_PLATFORM_METADATA,r.REQUEST_PLATFORM_METADATA_KEY_SCHEMA,a)},this.setBrowserName=function(a){
this.setInnerField(r.REQUEST_KEY_PLATFORM_METADATA,r.REQUEST_PLATFORM_METADATA_KEY_BROWSER_NAME,a)},this.setBrowserVersion=function(a){this.setInnerField(r.REQUEST_KEY_PLATFORM_METADATA,r.REQUEST_PLATFORM_METADATA_KEY_BROWSER_VERSION,a);
...
this.setField(r.REQUEST_PLATFORM_METADATA_KEY_FRAMEWORK_VERSION,a)},this.setOperatingSystemName=function(a){this.setInnerField(r.REQUEST_KEY_PLATFORM_METADATA,r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_NAME,a),
this.setField(r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_NAME,a)},this.setOperatingSystemVersion=function(a){this.setInnerField(r.REQUEST_KEY_PLATFORM_METADATA,r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_VERSION,a),
this.setField(r.REQUEST_PLATFORM_METADATA_KEY_OPERATING_SYSTEM_VERSION,a)},this.setPlayheadTime=function(a){this.setField(r.REQUEST_KEY_PLAYHEAD_TIME,a)},this.setBufferLength=function(a){this.setField(r.REQUEST_KEY_BUFFER_LENGTH,a);
},this.setStreamUrl=function(a){this.setField(r.REQUEST_KEY_STREAM_URL,a)},this.setStreamWidth=function(a){this.setField(r.REQUEST_KEY_VIDEO_WIDTH,a)},this.setStreamHeight=function(a){this.setField(r.REQUEST_KEY_VIDEO_HEIGHT,a);
},this.setConnectionType=function(a){this.setField(r.REQUEST_KEY_CONNECTION_TYPE,a)},this.setLinkEncryption=function(a){this.setField(r.REQUEST_KEY_LINK_ENCRYPTION,a)},this.setIsAdSession=function(){this.setField(r.REQUEST_KEY_IS_AD_SESSION,!0);
},this.setSignalStrength=function(a){this.setField(r.REQUEST_KEY_SIGNAL_STRENGTH,a)},this.setModuleName=function(a){this.setInnerField(r.REQUEST_PLATFORM_METADATA_KEY_CLIENT_CONFIGURATION,r.REQUEST_PLATFORM_METADATA_KEY_MODULE_NAME,a);
},this.setModuleVersion=function(a){this.setInnerField(r.REQUEST_PLATFORM_METADATA_KEY_CLIENT_CONFIGURATION,r.REQUEST_PLATFORM_METADATA_KEY_MODULE_VERSION,a)}},u=b.CwsSession=function(a,b,d,e,f,g,i,j,k,l,m){
function n(a,b,c,d,e,f,g,h,i,j,k){this._eventQueue=a,this._client=b,this._clientSettings=c,this._logger=d,this._logger.setModuleName("CwsSession"),this._exceptionCatcher=e,this._timer=f,this._gatewayControl=g,
this._cwsProtocol=h,this._time=i,this._logBuffer=j,this._clientConfig=k}var o=this;o._heartbeatTimerCancel=null,o._startTimeMs=0,o._heartbeatSequenceNumber=0,o._sessionFlags=r.SessionFlags.GLOBAL,o._capabilities=r.Capabilities.INSIGHTS,
o._heartbeatInfos=[],o._lastRequestSentMs=-1,o._bitrateKbps=-2,o._resource=null,o._playerState=h.PlayerState.NOT_MONITORED,o._encodedFrameRate=-1,o._contentLengthSec=-1,o._streamUrl=null,o._width=-1,o._height=-1,
o._playerStateManager=null,o._assetName=null,o._viewerId=null,o._playerName=null,o._isLive=null,o._tags={},o._browserName=null,o._browserVersion=null,o._deviceBrand=null,o._deviceManufacturer=null,o._deviceModel=null,
o._deviceType=null,o._deviceVersion=null,o._frameworkName=null,o._frameworkVersion=null,o._operatingSystemName=null,o._operatingSystemVersion=null,o._moduleName=null,o._moduleVersion=null,o._connectionType=null,
o._linkEncryption=null,o._pauseJoin=!1,o._hasJoined=!1,o._cleanedUp=!1,o._willEndSoon=!1,o._rfpsTimerCancel=null,o._rfpsTimerInterval=1e3,o._playingFpsObservationCount=0,o._playingFpsTotal=0,n.apply(this,arguments),
this.cleanup=function(){this._clientConfig=null,this._logBuffer=null,this._systemSettings=null,this._time=null,this._cwsProtocol=null,this._gatewayControl=null,this._timer=null,this._exceptionCatcher=null,
this._logger=null,this._clientSettings=null,this._client=null,this._eventQueue.flush(),this._eventQueue=null,this._cleanedUp=!0},this.start=function(a){this._session=a,this._global=this._session._global,
this._logger.setSessionId(this._session._id),this._startTimeMs=this._time.current(),(this.isVideoSession()||this.isAdSession())&&(this._sessionFlags+=u.DEFAULT_VIDEO_SESSION_FLAGS)},this.willEndSoon=function(){
this._willEndSoon=!0},this.initialize=function(){this._logger.debug("initialize()")},this.end=function(){(this.isVideoSession()||this.isAdSession())&&(this._logger.debug("end(): schedule the last hb before session cleanup"+o.sessionTypeTag()),
...
var b=o._operatingSystemVersion;b!==a&&null!=a&&(o._logger.debug("Change operatingSystemVersion from "+b+" to "+a),o._operatingSystemVersion=a)},this.getFrameworkName=function(){return o._frameworkName;
},this.setFrameworkName=function(a){o._logger.debug("setFrameworkName(): "+a);var b=o._frameworkName;b!==a&&null!=a&&(o._logger.debug("Change frameworkName from "+b+" to "+a),o._frameworkName=a)},this.getFrameworkVersion=function(){
return o._frameworkVersion},this.setFrameworkVersion=function(a){o._logger.debug("setFrameworkVersion(): "+a);var b=o._frameworkVersion;b!==a&&null!=a&&(o._logger.debug("Change frameworkVersion from "+b+" to "+a),
o._frameworkVersion=a)},this.setStreamUrl=function(a){o._logger.debug("setStreamUrl(): "+a);var b=o._streamUrl;b!==a&&null!=a&&(o._logger.debug("Change stream url from "+b+" to "+a),o._streamUrl=a)},this.setBitrateKbps=function(a){
...
},this.enqueueSessionEndEvent=function(){var a=this.getSessionTime(),b=this.getNextEventNumber(),c=this._cwsProtocol.generateSessionEndEvent(b,a);this._eventQueue.enqueue(c)},this.enqueueTagsChangeEvent=function(a,b){
var c=null;C.dictCount(a)>0&&(c={},c[r.REQUEST_KEY_TAGS]=a);var d={};d[r.REQUEST_KEY_TAGS]=b,this.declareStateChange(d,c)},this.enqueueAssetNameChangeEvent=function(a,b){var c={};c[r.REQUEST_KEY_ASSET_NAME]=b,
this.declareStateChange(c,null)},this.enqueueErrorEvent=function(a,b){var c={};c[r.REQUEST_ERROR_EVENT_KEY_MESSAGE]=a,c[r.REQUEST_ERROR_EVENT_KEY_FATAL]=b,this.enqueueEvent(r.EVENT_TYPE_ERROR,c)},this.enqueueBitrateChangeEvent=function(a,b){
var c={},d={};a>0&&(d[r.REQUEST_KEY_BITRATE]=a),c[r.REQUEST_KEY_BITRATE]=b,this.declareStateChange(c,d)},this.enqueueSeekEvent=function(a,b){var c={};c[r.REQUEST_EVENT_KEY_SEEK_ACT_TYPE]=a,b>=0&&(c[r.REQUEST_EVENT_KEY_SEEK_TO_POS]=b),
this.enqueueEvent(r.EVENT_TYPE_SEEK,c)},this.enqueueResourceChangeEvent=function(a,b){var c={},d={};null!==a&&(d[r.REQUEST_KEY_RESOURCE]=a),c[r.REQUEST_KEY_RESOURCE]=b,this.declareStateChange(c,d)},this.enqueueStreamUrlChangeEvent=function(a,b){
var c={},d={};null!==a&&(d[r.REQUEST_KEY_STREAM_URL]=a),c[r.REQUEST_KEY_STREAM_URL]=b,this.declareStateChange(c,d)},this.enqueueResolutionWidthChangeEvent=function(a,b){var c={},d={};-1!==a&&(d[r.REQUEST_KEY_VIDEO_WIDTH]=a),
c[r.REQUEST_KEY_VIDEO_WIDTH]=b,this.declareStateChange(c,d)},this.enqueueResolutionHeightChangeEvent=function(a,b){var c={},d={};-1!==a&&(d[r.REQUEST_KEY_VIDEO_HEIGHT]=a),c[r.REQUEST_KEY_VIDEO_HEIGHT]=b,
this.declareStateChange(c,d)},this.enqueueConnectionTypeChangeEvent=function(a,b){var c={},d={};null!==a&&(d[r.REQUEST_KEY_CONNECTION_TYPE]=a),c[r.REQUEST_KEY_CONNECTION_TYPE]=b,this.declareStateChange(c,d);
},this.enqueueLinkEncryptionChangeEvent=function(a,b){var c={},d={};null!==a&&(d[r.REQUEST_KEY_LINK_ENCRYPTION]=a),c[r.REQUEST_KEY_LINK_ENCRYPTION]=b,this.declareStateChange(c,d)},this.enqueuePauseJoinChangeEvent=function(a,b){
var c={},d={};d[r.REQUEST_KEY_PAUSE_JOIN]=a,c[r.REQUEST_KEY_PAUSE_JOIN]=b,this.declareStateChange(c,d)},this.enqueuePlayerStateChangeEvent=function(a,b){var c={},d={};c[r.REQUEST_KEY_PLAYER_STATE]=r.convertPlayerState(b),
d[r.REQUEST_KEY_PLAYER_STATE]=r.convertPlayerState(a),this.declareStateChange(c,d)},this.enqueueDataSamplesEvent=function(){var a={};this.enqueueEvent(r.EVENT_TYPE_DATA_SAMPLE,a)},this.declareStateChange=function(a,b){
var c={};c[r.REQUEST_STATE_CHANGE_EVENT_KEY_NEW]=a,null!=b&&C.dictCount(b)>0&&(c[r.REQUEST_STATE_CHANGE_EVENT_KEY_OLD]=b),this.enqueueEvent(r.EVENT_TYPE_STATE_CHANGE,c)},this.enqueueCustomEvent=function(a,b){
var c={};c[r.REQUEST_CUSTOM_EVENT_KEY_NAME]=a,c[r.REQUEST_CUSTOM_EVENT_KEY_ATTRIBUTES]=b,this.enqueueEvent(r.EVENT_TYPE_CUSTOM,c)},this.cancelHeartbeatTimer=function(){null!=o._heartbeatTimerCancel&&(o._heartbeatTimerCancel(),
o._heartbeatTimerCancel=null)},this.resetHeartbeatTimer=function(){o.cancelHeartbeatTimer();var a=1e3*o._clientSettings.heartbeatInterval;o._heartbeatTimerCancel=o._timer.create(o.sendHeartbeat,a,"Session.sendHeartbeat");
},this.cancelRfpsTimer=function(){null!=o._rfpsTimerCancel&&(o._rfpsTimerCancel(),o._rfpsTimerCancel=null)},this.startRfpsTimer=function(){o.cancelRfpsTimer(),o._rfpsTimerCancel=o._timer.create(o.countRfps,o._rfpsTimerInterval,"Session.startRfpsTimer");
...
null!=o._operatingSystemVersion&&b.setOperatingSystemVersion(o._operatingSystemVersion),null!=o._playerStateManager&&(o._moduleName=o._playerStateManager.getModuleName(),null!=o._moduleName&&b.setModuleName(o._moduleName)),
null!=o._playerStateManager&&(o._moduleVersion=o._playerStateManager.getModuleVersion(),null!=o._moduleVersion&&b.setModuleVersion(o._moduleVersion)),null!=o._viewerId&&b.setViewerId(o._viewerId),C.dictCount(o._tags)>0&&b.setTags(o._tags),
o.isVideoSession()||o.isAdSession()){o.isAdSession()&&b.setIsAdSession(),null!=o._assetName&&b.setAssetName(o._assetName),b.setSessionFlags(o._sessionFlags);var d=r.convertPlayerState(o._playerState);b.setPlayerState(d),
b.setPauseJoin(o._pauseJoin),null!=o._playerName&&b.setPlayerName(o._playerName),null!=o._isLive&&b.setIsLive(o._isLive),o._contentLengthSec>0&&b.setContentLength(o._contentLengthSec),o._bitrateKbps>0&&b.setBitrate(o._bitrateKbps),
null!==o._resource&&b.setResource(o._resource),o._encodedFrameRate>0&&b.setEncodedFrameRate(o._encodedFrameRate);var e,f,g;null!=o._playerStateManager&&(e=G.Integer(o._playerStateManager.getPHT(),0,null,-1),
f=G.Integer(o._playerStateManager.getBufferLength(),0,null,-1),g=o._playerStateManager.getSignalStrength()),e>=0&&b.setPlayheadTime(e),f>0&&b.setBufferLength(f);var h=o.updateAverageFrameRate();h>0&&b.setAverageFrameRate(h),
o._playingFpsTotal>0&&b.setRfpsTotal(G.Integer(o._playingFpsTotal,0,null,-1)),o._playingFpsObservationCount>0&&b.setRfpsObservationCount(G.Integer(o._playingFpsObservationCount,0,null,-1)),0>=g&&b.setSignalStrength(g),
null!=o._streamUrl&&b.setStreamUrl(o._streamUrl),o._width>0&&b.setStreamWidth(o._width),o._height>0&&b.setStreamHeight(o._height)}else b.setSessionFlags(r.SessionFlags.GLOBAL);if(a.length>0&&b.setEvents(a),
b.setCapabilities(o._capabilities),b.setIsSdkClient(!0),o._clientConfig.get(y.CONFIG_KEY_SEND_LOGS)&&b.setLogs(o._logBuffer.flush()),o._clientConfig.get(y.CONFIG_KEY_MAX_HEARTBEAT_INFOS)>0){var i=o.compileHeartbeatInfos();
i.length>0&&b.setHeartbeatInfos(i)}return b.setSessionStartTime(o._startTimeMs),b.setSessionTime(o.getSessionTime()),o._heartbeatSequenceNumber++,b.get()},this.sendHeartbeat=function(){if(!o._cleanedUp){
var a=o.makeHeartbeat();null!=a&&o.postHeartbeat(a)}},this.countRfps=function(){if(o._playerState===h.PlayerState.PLAYING){var a=o._playerStateManager.getRenderedFrameRate();a>=0&&(o._playingFpsTotal+=a,
...
null!=l&&c._cwsSession.setOperatingSystemName(l);var m=a[K.OPERATING_SYSTEM_VERSION];null!=m&&c._cwsSession.setOperatingSystemVersion(m)},this.setStatesFromContentMetadata=function(){if(c._logger.debug("setStatesFromContentMetadata()"),
null!=c._contentMetadata.defaultResource&&c._cwsSession.setResource(c._contentMetadata.defaultResource),null!=c._contentMetadata.streamUrl&&c._cwsSession.setStreamUrl(c._contentMetadata.streamUrl),c._contentMetadata.duration>0&&c._cwsSession.setContentLength(c._contentMetadata.duration),
c._contentMetadata.encodedFrameRate>0&&c._cwsSession.setEncodedFrameRate(c._contentMetadata.encodedFrameRate),c._contentMetadata.streamType!==e.StreamType.UNKNOWN){var a=c._contentMetadata.streamType===e.StreamType.LIVE;
c._cwsSession.setIsLive(a)}null!=c._contentMetadata.assetName&&c._cwsSession.setAssetName(c._contentMetadata.assetName),null!=c._contentMetadata.viewerId&&c._cwsSession.setViewerId(c._contentMetadata.viewerId),
null!=c._contentMetadata.applicationName&&c._cwsSession.setPlayerName(c._contentMetadata.applicationName),C.dictCount(c._contentMetadata.custom)>0&&c._cwsSession.setTags(c._contentMetadata.custom)},this.onPlayerStateChange=function(a){
...
},this.onBitrateChange=function(a){return c._logger.debug("onBitrateChange(): "+a),c._ignoreBitrateAndResource?void c._logger.info("onBitrateChange(): ignored"):void c._cwsSession.setBitrateKbps(a)},this.onSeekEvent=function(a,b){
null==b||C.isInteger(b)||(c._logger.error("onSeekEvent(): Ignored non-integer seekToPosition data: "+b),b=-1),c._cwsSession.enqueueSeekEvent(a,b)},this.onEncodedFrameRateChange=function(a){c._logger.debug("onEncodedFrameRateChange(): "+a),
c._contentMetadata.encodedFrameRate>0||(a>0?c._ignoreEncodedFrameRateAndDuration?c._logger.info("onEncodedFrameRateChange(): Ignored encoded frame rate data: "+a+" (ads)"):(c._cwsSession.setEncodedFrameRate(a),
...
this._logger.debug("save(): calling StorageInterface.saveData"),this._storageInterface.saveData(J.STORAGE_SPACE,a,b,d)}};J.STORAGE_SPACE="Conviva";var K=b.SystemMetadata=function(a,b,d){this._logger=a,
this._logger.setModuleName("SystemMetadata"),this._metadataInterface=b,this._exceptionCatcher=d,this._cachedMetadata=null,this.get=function(){return this._cachedMetadata||this.retrieve(),this._cachedMetadata;
},this.retrieve=function(){function a(a,b){d._exceptionCatcher.runProtected("Session.getSystemMetadataSchema(): "+a,function(){var c=b[a];b[a]=c.call(d._metadataInterface)})}var b={};b[K.BROWSER_NAME]=this._metadataInterface.getBrowserName,
b[K.BROWSER_VERSION]=this._metadataInterface.getBrowserVersion,b[K.DEVICE_BRAND]=this._metadataInterface.getDeviceBrand,b[K.DEVICE_MANUFACTURER]=this._metadataInterface.getDeviceManufacturer,b[K.DEVICE_MODEL]=this._metadataInterface.getDeviceModel,
b[K.DEVICE_TYPE]=this._metadataInterface.getDeviceType,b[K.DEVICE_VERSION]=this._metadataInterface.getDeviceVersion,b[K.FRAMEWORK_NAME]=this._metadataInterface.getFrameworkName,b[K.FRAMEWORK_VERSION]=this._metadataInterface.getFrameworkVersion,
b[K.OPERATING_SYSTEM_NAME]=this._metadataInterface.getOperatingSystemName,b[K.OPERATING_SYSTEM_VERSION]=this._metadataInterface.getOperatingSystemVersion;var d=this;this._logger.debug("retrieve(): calling MetadataInterface methods");
for(var e in b)a(e,b),C.isValidString(b[e])||delete b[e];b[K.DEVICE_TYPE]!==c.DeviceType.DESKTOP&&b[K.DEVICE_TYPE]!==c.DeviceType.CONSOLE&&b[K.DEVICE_TYPE]!==c.DeviceType.SETTOP&&b[K.DEVICE_TYPE]!==c.DeviceType.MOBILE&&b[K.DEVICE_TYPE]!==c.DeviceType.TABLET&&b[K.DEVICE_TYPE]!==c.DeviceType.SMARTTV&&delete b[K.DEVICE_TYPE],
this._cachedMetadata=C.ObjectShallowCopyOmitNull(b)}};K.BROWSER_NAME="browserName",K.BROWSER_VERSION="browserVersion",K.DEVICE_BRAND="deviceBrand",K.DEVICE_MANUFACTURER="deviceManufacturer",K.DEVICE_MODEL="deviceModel",
...
var L=b.Time=function(a,b){this._timeInterface=a,this._logger=b,this._logger.setModuleName("Time"),this.current=function(){var a=this._timeInterface.getEpochTimeMs();return C.isInteger(a)||this._logger.error("current(): TimeInterface.getEpochTimeMs() did not return an integer ("+a+")"),
